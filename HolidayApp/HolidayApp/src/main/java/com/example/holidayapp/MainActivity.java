...
import com.example.holidayapp.viewmodel.HolidayViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<>(this,
            android.R.layout.simple_list_item_1, holidayNames);
        holidayListView.setAdapter(adapter);

        holidayViewModel = new ViewModelProvider(this)
            .get(HolidayViewModel.class);
        holidayViewModel.getHolidays()
            .observe(this, new Observer<List<HolidayModel>>() {
                @Override
